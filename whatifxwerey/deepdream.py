...
def merge(source_img, guide_img, end='inception_3b/output'):
    source_data = np.float32(source_img)
    guide_data = np.float32(guide_img)

    result = deepdream(net, source_data, end=end, objective=objective(guide_data, end))
